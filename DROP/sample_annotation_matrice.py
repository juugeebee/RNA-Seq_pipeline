...
for f in listdir("../BAM") :
    if ('Aligned.sortedByCoord.out.bam' in f) and ('bai' not in f) :
        ...
        sample = id_l[0]
        drop_group.append('patient,fraser2,outrider,mae,variant_calling,PAXgene')
...
rna_bam_file.append('')
drop_group.append('temoin,fraser2,outrider,mae,variant_calling,PAXgene')
gene_counts_file.append('/media/jbogoin/Data1/DROP_external_counts_hg38_v47/outrider--hg38--v47/geneCounts.tsv.gz')
gene_annotation.append('v47')
splice_counts_dir.append('/media/jbogoin/Data1/DROP_external_counts_hg38_v47/fraser2--hg38--v47')
...
df['DNA_ID'] = rnaid
df['GENE_COUNTS_FILE'] = gene_counts_file
df['GENE_ANNOTATON'] = gene_annotation
df['SPLICE_COUNTS_DIR'] = splice_counts_dir
