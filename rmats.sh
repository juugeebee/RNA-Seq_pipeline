rmats.py --b1 '/media/jbogoin/Data2/rMATS/6624CY001245/rmats_control_bams.txt' \
    --b2 '/media/jbogoin/Data2/rMATS/6624CY001245/RNU5_bams.txt' \
    --gtf '/media/jbogoin/Data1/References/RNA-seq/hg38/rmats/gencode.v47.annotation.gtf' \
    -t paired --readLength 101 --od '/media/jbogoin/Data2/rMATS/6624CY001245/rmats_out' \
    --tmp '/media/jbogoin/Data2/rMATS/6624CY001245/tmp' \
    --anchorLength 1 --nthread 12 --libType fr-firststrand --task both --novelSS --variable-read-length --allow-clipping


rmats.py --b1 '/media/jbogoin/Data2/rMATS/6624CY001359/rmats_control_bams.txt' \
    --b2 '/media/jbogoin/Data2/rMATS/6624CY001359/RNU5_bams.txt' \
    --gtf '/media/jbogoin/Data1/References/RNA-seq/hg38/rmats/gencode.v47.annotation.gtf' \
    -t paired --readLength 101 --od '/media/jbogoin/Data2/rMATS/6624CY001359/rmats_out' \
    --tmp '/media/jbogoin/Data2/rMATS/6624CY001359/tmp' \
    --anchorLength 1 --nthread 12 --libType fr-firststrand --task both --novelSS --variable-read-length --allow-clipping
